...
| Chess board | chessground 9.2.1 (Lichess, MIT) |
| PGN viewer | @lichess-org/pgn-viewer (GPL-3) |
...
The chess board is powered by [chessground](https://github.com/lichess-org/chessground) (MIT) and [@lichess-org/pgn-viewer](https://github.com/lichess-org/pgn-viewer) (GPL-3).
